...
typedef enum _sai_wred_attr_t
{
     ...
     * @flags CREATE_AND_SET
     * @default 0
     * @validonly SAI_WRED_ATTR_GREEN_ENABLE == true or
     *            SAI_WRED_ATTR_ECN_MARK_MODE == SAI_ECN_MARK_MODE_GREEN or
     *            SAI_WRED_ATTR_ECN_MARK_MODE == SAI_ECN_MARK_MODE_GREEN_YELLOW or
     *            SAI_WRED_ATTR_ECN_MARK_MODE == SAI_ECN_MARK_MODE_GREEN_RED or
     ...
     * @flags CREATE_AND_SET
     * @default 0
     * @validonly SAI_WRED_ATTR_YELLOW_ENABLE == true or
     *            SAI_WRED_ATTR_ECN_MARK_MODE == SAI_ECN_MARK_MODE_YELLOW or
     *            SAI_WRED_ATTR_ECN_MARK_MODE == SAI_ECN_MARK_MODE_GREEN_YELLOW or
     *            SAI_WRED_ATTR_ECN_MARK_MODE == SAI_ECN_MARK_MODE_YELLOW_RED or
     *            SAI_WRED_ATTR_ECN_MARK_MODE == SAI_ECN_MARK_MODE_ALL
     */
     ...
     * @flags CREATE_AND_SET
     * @default 0
     * @validonly SAI_WRED_ATTR_RED_ENABLE == true or
     *            SAI_WRED_ATTR_ECN_MARK_MODE == SAI_ECN_MARK_MODE_RED or
     *            SAI_WRED_ATTR_ECN_MARK_MODE == SAI_ECN_MARK_MODE_GREEN_RED or
     *            SAI_WRED_ATTR_ECN_MARK_MODE == SAI_ECN_MARK_MODE_YELLOW_RED or
     *            SAI_WRED_ATTR_ECN_MARK_MODE == SAI_ECN_MARK_MODE_ALL
     */
